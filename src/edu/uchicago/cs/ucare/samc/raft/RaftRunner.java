...
public class RaftRunner {
	...
	final static Logger LOG = LoggerFactory.getLogger(RaftRunner.class);
	...
	protected static ModelCheckingServerAbstract createModelCheckerFromConf(String confFile, 
		...
		try {
            ...
            int numSnapshot = prop.getProperty("num_snapshot") != null ? Integer.parseInt(prop.getProperty("num_snapshot")) : 0;
            ...
            modelCheckingServerAbstract.setAdditionalConstraints(numSnapshot);
